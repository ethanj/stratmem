# TacNet Edge Pitch v3 — Compression Switch Under Degraded C2
...
**v3 team addenda:** `docs/team-a-backend-v3-addendum.md`, `docs/team-b-domain-pitch-v3-addendum.md`, `docs/team-c-frontend-components-v3-addendum.md`, `docs/team-d-integration-demo-v3-addendum.md`
